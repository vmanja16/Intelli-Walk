...
{   
    ...
    OC1CON = 0x0005; //  Initialize OCx pin low; generate continuous output pulses on OCx pin, dual compare
    OC1R   = 0x3000; // Start pulse time
    OC1RS  = 0x3005; // Stop pulse time
